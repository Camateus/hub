...
static esp_err_t bmx280_probe_address(bmx280_t *bmx280) {
	...
	ESP_LOGW("bmx280", "Probe failure: address=%hhx, id=%hhx, reason=%s", bmx280->slave, bmx280->chip_id,
	         esp_err_to_name(err));
	return err;
}
...
uint32_t bme280_compensate_H_int32(bmx280_t *bmx280, int32_t adc_H) {
	...
	v_x1_u32r = (((((adc_H << 14) - (((int32_t)bmx280->cmps.H4) << 20) - (((int32_t)bmx280->cmps.H5) * v_x1_u32r)) + ((
	                                                                                                                      int32_t)16384)) >> 15) * (((((((v_x1_u32r * ((int32_t)bmx280->cmps.H6)) >> 10) * (((v_x1_u32r * ((
	                                                                                                                              int32_t)bmx280->cmps.H3)) >> 11) + ((int32_t)32768))) >> 10) + ((int32_t)2097152)) * ((
	                                                                                                                                      int32_t)bmx280->cmps.H2) + 8192) >> 14));
